...
UINT CStdioFileEx::ProcessFlags(UINT& nOpenFlags)
{
	...
	{
		assert2log(nOpenFlags & CFile::modeWrite || nOpenFlags & CFile::modeReadWrite);
	}
#endif
